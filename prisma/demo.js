...
async function main() {
  ...
  const salesData = [
    ...
    { daysAgo: 1,  customer: customers[4], method: 'NEQUI',    type: 'MAYOR', items: [[products[1],3],[products[11],2]] },
    { daysAgo: 1,  customer: customers[7], method: 'EFECTIVO', type: 'MAYOR', items: [[products[3],2],[products[13],1]] },
    { daysAgo: 2,  customer: customers[0], method: 'TRANSFERENCIA', type: 'MAYOR', items: [[products[0],3],[products[6],2]] },
    { daysAgo: 3,  customer: customers[9], method: 'EFECTIVO', type: 'MAYOR', items: [[products[4],2],[products[10],1]] },
    { daysAgo: 3,  customer: customers[5], method: 'NEQUI',    type: 'DETAL', items: [[products[2],1],[products[8],1]] },
    ...
    { daysAgo: 6,  customer: customers[9], method: 'TRANSFERENCIA', type: 'MAYOR', items: [[products[6],1],[products[13],2]] },
    { daysAgo: 7,  customer: customers[2], method: 'EFECTIVO', type: 'MAYOR', items: [[products[0],5],[products[1],3]] },
    { daysAgo: 8,  customer: customers[5], method: 'NEQUI',    type: 'DETAL', items: [[products[2],2],[products[7],1]] },
    ...
    { daysAgo: 14, customer: customers[2], method: 'TRANSFERENCIA', type: 'MAYOR', items: [[products[0],3],[products[13],1]] },
    { daysAgo: 15, customer: customers[9], method: 'NEQUI',    type: 'MAYOR', items: [[products[5],2],[products[12],2]] },
    ...
    { daysAgo: 28, customer: customers[7], method: 'TRANSFERENCIA', type: 'MAYOR', items: [[products[6],3],[products[11],2]] },
  ];
